    ...
    <body>
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <nav class="navbar navbar-default" style="background-color: #215584;">
                        <div class="container-fluid">
                            <% OpcionesMenu opcion = OpcionesMenu.POSICIONES; %>
            ...
            <div class="row">
              ...
              <div class="col-sm-8">
                <h3>Posiciones</h3>
                <p>En este sitio podrá gestionar la lista de Posiciones de los jugadores registrados.</p>
                <table class="table table-striped">
                      ...
                      <%
                        ...
                        %>
                          <tr>
                            <td><%= posicion.getNombre()%></td>
                            <td align="center">
                                <a href="#" onclick="modificarPosicion(<%= posicion.getCodigo() %>)"><span class="glyphicon glyphicon glyphicon-edit" style="cursor: pointer"></span></a>
                            </td>
                            <td align="center">
                                <a href="#" onclick="eliminarPosicion(<%= posicion.getCodigo() %>)"><span class="glyphicon glyphicon glyphicon-remove" style="cursor: pointer"></span></a>
                            </td>
                          </tr>
                          <%
                                }
                            ...
                            %>
                            <tr>
                                <td colspan="7"><h4>No hay Posiciones registradas</h4></td>
                            </tr>
                          <%
                            }
                      %>
                ...
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title">Agregar nueva Posición</h4>
                    </div>
                    <div class="modal-body">
                      <form action="./PosicionController" method="post">
                            <input type="hidden" name="accion" value="agregar">
                            <div class="form-group">
                                <label for="nombre">Posición</label>
                                <input id="nombre" type="text" class="form-control" name="nombre" placeholder="Nombre de la Posición">
                            </div>
                    </div>
            ...
            <form name="FormEliminar" id="FormEliminar" method="post" action="PosicionController">
